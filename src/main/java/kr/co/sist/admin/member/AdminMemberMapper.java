...
public interface AdminMemberMapper {
        ...
        public List<UserDomain> selectUserListByPage(@Param("startRow") int startRow, @Param("endRow") int endRow)
                        throws PersistenceException;

        public int selectUserCount() throws PersistenceException;
        ...
        public List<InstructorDomain> selectInstructorListByPage(@Param("startRow") int startRow,
                        @Param("endRow") int endRow)
                        throws PersistenceException;

        public int selectInstructorCount() throws PersistenceException;
