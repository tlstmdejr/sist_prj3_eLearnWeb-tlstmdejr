...
public class StudentDAO {
     ...
     */
    public StudentDomain selectOneStu(String stuId) throws PersistenceException {
...
//.common으로 이동시켜서 공통으로 사용할예정
     ...
     * @throws PersistenceException DB 예외
     */
    public int insertStu(StudentDTO sDTO) throws PersistenceException {
        int result = 0;
     ...
     * @throws PersistenceException DB 예외
     */
    public int updateStu(StudentDTO sDTO) throws PersistenceException {
        int result = 0;
