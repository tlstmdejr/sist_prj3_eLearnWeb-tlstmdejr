...
CREATE TABLE USERS (USER_ID VARCHAR2(30) PRIMARY KEY, PASSWORD VARCHAR2(100) NOT NULL, EMAIL VARCHAR2(100) NOT NULL, INTRO VARCHAR2(1000), NAME VARCHAR2(100) NOT NULL, PHONE VARCHAR2(11) NOT NULL, ACTIVATION number(1) NOT NULL, BIRTH DATE NOT NULL, PROFILE VARCHAR2(50) NOT NULL, REGDATE DATE DEFAULT SYSDATE NOT NULL, REGIP VARCHAR2(30) NOT NULL);
CREATE TABLE LECTURE (LECT_ID VARCHAR2(30) PRIMARY KEY, NAME VARCHAR2(100) NOT NULL, PRICE NUMBER(6), SHORTINT VARCHAR2(100) NOT NULL, INTRO CLOB NOT NULL, COUNT NUMBER(2) NOT NULL, LENGTH NUMBER(3) NOT NULL, AVAILABILITY NUMBER(1) NOT NULL, CAT_ID VARCHAR2(30) REFERENCES CATEGORY(CAT_ID), INST_ID VARCHAR2(30) REFERENCES INSTRUCTOR(INST_ID), THUMBNAIL VARCHAR2(1000) NOT NULL, USERCOUNT NUMBER(5) NOT NULL, REGDATE DATE DEFAULT SYSDATE NOT NULL, REGIP VARCHAR2(30) NOT NULL, APPROVAL NUMBER(1) NOT NULL, REJECT_REASON VARCHAR2(1000));
...
CREATE TABLE MY_CHAPTER (MY_CHAPTER_ID VARCHAR2(30) PRIMARY KEY, CHPTR_ID VARCHAR2(30) REFERENCES CHAPTER(CHPTR_ID), USER_ID VARCHAR2(30) REFERENCES USERS(USER_ID), LASTDATE DATE, PROGRESS NUMBER(3) NOT NULL, PROGTIME NUMBER(5) NOT NULL, STATE NUMBER(1) NOT NULL,ACTUALTIME NUMBER(5) NOT NULL);
...
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p1', TO_DATE('1980-01-01','YYYY-MM-DD'), 'i1@test.com', '강사1', '01011110001', 'i1.jpg', 1, 1, TO_DATE('2005-01-01','YYYY-MM-DD'), '0.0.0.2');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p2', TO_DATE('1981-01-01','YYYY-MM-DD'), 'i2@test.com', '강사2', '01011110002', 'i2.jpg', 1, 1, TO_DATE('2026-01-29','YYYY-MM-DD'), '0.0.8.0');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p3', TO_DATE('1982-01-01','YYYY-MM-DD'), 'i3@test.com', '강사3', '01011110003', 'i3.jpg', 1, 1, TO_DATE('2026-01-29','YYYY-MM-DD'), '0.0.0.5');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p4', TO_DATE('1983-01-01','YYYY-MM-DD'), 'i4@test.com', '강사4', '01011110004', 'i4.jpg', 1, 1, TO_DATE('2022-04-07','YYYY-MM-DD'), '0.0.0.7');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p5', TO_DATE('1984-01-01','YYYY-MM-DD'), 'i5@test.com', '강사5', '01011110005', 'i5.jpg', 1, 1, TO_DATE('2026-01-29','YYYY-MM-DD'), '0.0.0.3');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p6', TO_DATE('1985-01-01','YYYY-MM-DD'), 'i6@test.com', '강사6', '01011110006', 'i6.jpg', 1, 1, TO_DATE('2017-04-01','YYYY-MM-DD'), '0.0.0.2');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p7', TO_DATE('1986-01-01','YYYY-MM-DD'), 'i7@test.com', '강사7', '01011110007', 'i7.jpg', 1, 1, TO_DATE('2005-01-01','YYYY-MM-DD'), '0.0.0.4');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p8', TO_DATE('1987-01-01','YYYY-MM-DD'), 'i8@test.com', '강사8', '01011110008', 'i8.jpg', 1, 1, TO_DATE('2017-04-01','YYYY-MM-DD'), '0.0.0.5');
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p9', TO_DATE('1988-01-01','YYYY-MM-DD'), 'i9@test.com', '강사9', '01011110009', 'i9.jpg', 0, 1, TO_DATE('2005-01-01','YYYY-MM-DD'), '0.4.0.0'); -- 비활성
INSERT INTO INSTRUCTOR VALUES ('inst' || SEQ_INSTRUCTOR_ID.NEXTVAL, 'p10', TO_DATE('1989-01-01','YYYY-MM-DD'), 'i10@test.com', '강사10', '01011110010', 'i10.jpg', 1, 1, TO_DATE('2017-04-01','YYYY-MM-DD'), '0.0.0.1');

INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u1', 'u1@naver.com','멋쟁이', '이정우', '01022220001', 1, TO_DATE('1995-01-01','YYYY-MM-DD'),'u1.jpg', TO_DATE('2005-01-01','YYYY-MM-DD'),'0.4.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u2', 'u2@naver.com','진짜멋쟁이', '남지우', '01022220001', 1, TO_DATE('1995-01-01','YYYY-MM-DD'),'u2.jpg', TO_DATE('2005-01-01','YYYY-MM-DD'),'0.4.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u3', 'u3@naver.com','레알멋쟁이', '이지원', '01022220003', 1, TO_DATE('1997-01-01','YYYY-MM-DD'),'u3.jpg', TO_DATE('2026-01-29','YYYY-MM-DD'),'0.0.5.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u4', 'u4@naver.com', '자바를 좋아하는 학생','신승덕', '01022220004', 1, TO_DATE('1998-01-01','YYYY-MM-DD'),'u4.jpg', TO_DATE('2026-01-29','YYYY-MM-DD'),'0.1.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u5', 'u5@naver.com','노캡으로 멋쟁이', '최승준', '01022220005', 1, TO_DATE('1999-01-01','YYYY-MM-DD'),'u5.jpg', TO_DATE('2022-04-07','YYYY-MM-DD'),'0.4.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u6', 'u6@naver.com','겁쟁이', '버즈', '01022220006', 1, TO_DATE('2000-01-01','YYYY-MM-DD'),'u6.jpg', TO_DATE('2021-04-05','YYYY-MM-DD'),'0.0.2.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u7', 'u7@naver.com','집가고싶은 학생', '나경원', '01022220007', 1, TO_DATE('2001-01-01','YYYY-MM-DD'),'u7.jpg', TO_DATE('1951-01-09','YYYY-MM-DD'),'0.7.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u8', 'u8@naver.com','공부하기싫은 학생', '윤자빈', '01022220008', 1, TO_DATE('2002-01-01','YYYY-MM-DD'),'u8.jpg', TO_DATE('2009-05-21','YYYY-MM-DD'),'0.0.5.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u9', 'u9@naver.com','생물학적 남성', '박상현', '01022220009', 1, TO_DATE('2003-01-01','YYYY-MM-DD'),'u9.jpg', TO_DATE('2017-04-01','YYYY-MM-DD'),'0.4.0.1');
INSERT INTO USERS VALUES ('user' || SEQ_USERS_ID.NEXTVAL, 'u10', 'u10@naver.com','생물학적 중성', '고준서', '01022220010', 0, TO_DATE('2004-01-01','YYYY-MM-DD'),'u10.jpg', TO_DATE('2015-04-01','YYYY-MM-DD'),'0.0.0.7');
...
--CHAPTER 데이터 : Lect마다 하나씩
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, 1, '인트로', 10, 'lect.ppt', TO_DATE('2026-05-09','YYYY-MM-DD'),'WB_q0lcmOFQ',TO_DATE('2026-05-09','YYYY-MM-DD'), 'L1');
...
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, 1, '파이썬 기초', 20,'lect.ppt',TO_DATE('2020-04-07','YYYY-MM-DD'), 'kWiCuklohdY',TO_DATE('2026-05-09','YYYY-MM-DD'), 'L3');
...
--CHAPTER 데이터 : Lect 별로 4개씩 추가
-- num이 Lect 기준으로 순차적으로 쌓이게
-- L1: 자바 마스터
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L1'), '자바 환경설정', 15, 'java_01.ppt', TO_DATE('2025-01-10','YYYY-MM-DD'), 'cg1xvFy1JQQ', SYSDATE, 'L1');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L1'), '변수와 자료형', 20, 'java_02.ppt', TO_DATE('2025-01-11','YYYY-MM-DD'), 'YRWhXRc5-_8', SYSDATE, 'L1');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L1'), '객체지향의 이해', 25, 'java_03.ppt', TO_DATE('2025-01-12','YYYY-MM-DD'), 'dy9yQIx38u8', SYSDATE, 'L1');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L1'), '컬렉션 프레임워크', 30, 'java_04.ppt', TO_DATE('2025-01-13','YYYY-MM-DD'), 'cbuZfY2S2UQ', SYSDATE, 'L1');

-- L2: 자바설치
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L2'), '첫 프로젝트 생성', 10, 'java_install_1.ppt', TO_DATE('2025-02-01','YYYY-MM-DD'), 'www.video_l2_2.com', SYSDATE, 'L2');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L2'), 'JDK와 JRE 차이', 15, 'java_install_2.ppt', TO_DATE('2025-02-02','YYYY-MM-DD'), 'www.video_l2_3.com', SYSDATE, 'L2');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L2'), '환경변수 설정법', 20, 'java_install_3.ppt', TO_DATE('2025-02-03','YYYY-MM-DD'), 'www.video_l2_4.com', SYSDATE, 'L2');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L2'), 'Hello World 출력', 10, 'java_install_4.ppt', TO_DATE('2025-02-04','YYYY-MM-DD'), 'www.video_l2_5.com', SYSDATE, 'L2');

-- L3: 파이썬 기초
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L3'), '리스트와 딕셔너리', 20, 'py_01.ppt', TO_DATE('2025-03-05','YYYY-MM-DD'), 'UMfCZMuZoRk', SYSDATE, 'L3');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L3'), '반복문과 조건문', 25, 'py_02.ppt', TO_DATE('2025-03-06','YYYY-MM-DD'), 'sS3NQrnfGzQ', SYSDATE, 'L3');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L3'), '함수 정의하기', 15, 'py_03.ppt', TO_DATE('2025-03-07','YYYY-MM-DD'), 'WRhCvVooCUo', SYSDATE, 'L3');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L3'), '외장 라이브러리 활용', 30, 'py_04.ppt', TO_DATE('2025-03-08','YYYY-MM-DD'), 'M-S2ctyAeaY', SYSDATE, 'L3');

-- L4: 다트 언어
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L4'), '비동기 프로그래밍', 25, 'dart_01.ppt', TO_DATE('2025-04-10','YYYY-MM-DD'), 'www.video_l4_2.com', SYSDATE, 'L4');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L4'), '클래스와 믹스인', 20, 'dart_02.ppt', TO_DATE('2025-04-11','YYYY-MM-DD'), 'www.video_l4_3.com', SYSDATE, 'L4');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L4'), '제네릭 활용', 15, 'dart_03.ppt', TO_DATE('2025-04-12','YYYY-MM-DD'), 'www.video_l4_4.com', SYSDATE, 'L4');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L4'), '다트 패키지 관리', 10, 'dart_04.ppt', TO_DATE('2025-04-13','YYYY-MM-DD'), 'www.video_l4_5.com', SYSDATE, 'L4');

-- L5: 유니티 설치
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L5'), '인터페이스 탐색', 20, 'unity_01.ppt', TO_DATE('2025-05-15','YYYY-MM-DD'), 'www.video_l5_2.com', SYSDATE, 'L5');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L5'), '게임 오브젝트와 컴포넌트', 30, 'unity_02.ppt', TO_DATE('2025-05-16','YYYY-MM-DD'), 'www.video_l5_3.com', SYSDATE, 'L5');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L5'), 'C# 스크립팅 기초', 35, 'unity_03.ppt', TO_DATE('2025-05-17','YYYY-MM-DD'), 'www.video_l5_4.com', SYSDATE, 'L5');
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L5'), '프리팹(Prefab) 활용', 25, 'unity_04.ppt', TO_DATE('2025-05-18','YYYY-MM-DD'), 'www.video_l5_5.com', SYSDATE, 'L5');
...
-- MY_CHAPTER
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH1', 'user1', SYSDATE, 50, 50, 0, NVL(45, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH2', 'user2', SYSDATE, 100, 150, 1, NVL(148, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH3', 'user3', SYSDATE, 50, 10, 0, NVL(5, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH4', 'user4', SYSDATE, 80, 200, 0, NVL(190, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH5', 'user5', SYSDATE, 100, 300, 1, NVL(295, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH6', 'user6', SYSDATE, 10, 20, 0, NVL(5, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH7', 'user7', SYSDATE, 60, 120, 0, NVL(115, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH8', 'user8', SYSDATE, 100, 300, 1, NVL(300, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH9', 'user9', SYSDATE, 40, 80, 0, NVL(70, 0));

-- USER1 추가 데이터 (L1~L3 관련)
-- CH2, CH3, CH4
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH2', 'user1', SYSDATE, 100, 15, 1, NVL(15, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH3', 'user1', SYSDATE,  20, 40, 0, NVL(10, 0)); -- 스킵 많이 했다고 가정
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH4', 'user1', SYSDATE, 0, 0, 0, NVL(0, 0));

-- CH11, CH12, CH13
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH11', 'user1', SYSDATE, 100, 15, 1, NVL(15, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH12', 'user1', SYSDATE, 50, 10, 0, NVL(5, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH13', 'user1', SYSDATE, 0, 0, 0, NVL(0, 0));

-- CH14, CH15, CH16
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH14', 'user1', SYSDATE, 100, 20, 1, NVL(20, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH15', 'user1', SYSDATE, 100, 25, 1, NVL(25, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH16', 'user1', SYSDATE, 30, 9, 0, NVL(3, 0));

-- CH17, CH18, CH19
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH17', 'user1', SYSDATE, 100, 15, 1, NVL(15, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH18', 'user1', SYSDATE, 80, 20, 0, NVL(16, 0));
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH19', 'user1', SYSDATE, 10, 3, 0, NVL(1, 0));
...
select * from lecture;
select * from my_lecture;

select * from users;

------------이미지 update 문----------
------------나중에 t1.jpg ~ t10.jpg 업데이트 할 때 사용할 문
commit;
