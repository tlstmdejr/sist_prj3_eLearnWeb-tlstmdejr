...
--CHAPTER 데이터 추가
-- L1 강의 관련 (3개)
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '자바 환경설정', 15, 'java_1.ppt', TO_DATE('2025-01-10','YYYY-MM-DD'), 'www.video_l1_1.com', SYSDATE, 'L1');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '변수와 자료형', 20, 'java_2.ppt', TO_DATE('2025-01-11','YYYY-MM-DD'), 'www.video_l1_2.com', SYSDATE, 'L1');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '제어문 마스터', 30, 'java_3.ppt', TO_DATE('2025-01-12','YYYY-MM-DD'), 'www.video_l1_3.com', SYSDATE, 'L1');

-- L2 강의 관련 (3개)
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '파이썬 기초 문법', 20, 'py_01.ppt', TO_DATE('2025-02-01','YYYY-MM-DD'), 'www.video_l2_1.com', SYSDATE, 'L2');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '리스트와 튜플', 25, 'py_02.ppt', TO_DATE('2025-02-02','YYYY-MM-DD'), 'www.video_l2_2.com', SYSDATE, 'L2');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '함수와 모듈', 30, 'py_03.ppt', TO_DATE('2025-02-03','YYYY-MM-DD'), 'www.video_l2_3.com', SYSDATE, 'L2');

-- L3 강의 관련 (3개)
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '데이터베이스 개요', 15, 'db_01.ppt', TO_DATE('2025-03-05','YYYY-MM-DD'), 'www.video_l3_1.com', SYSDATE, 'L3');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, 'SELECT문 기초', 25, 'db_02.ppt', TO_DATE('2025-03-06','YYYY-MM-DD'), 'www.video_l3_2.com', SYSDATE, 'L3');
INSERT INTO CHAPTER VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, SEQ_CHAPTER_ID.CURRVAL, '조인(JOIN) 완벽 이해', 35, 'db_03.ppt', TO_DATE('2025-03-07','YYYY-MM-DD'), 'www.video_l3_3.com', SYSDATE, 'L3');
...
--MY_CHAPTER 추가 데이터
-- USER10이 CH11, CH12, CH13 수강 (L1 관련 챕터들)
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH11', 'user1', SYSDATE, 100, 15, 1);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH12', 'user1', SYSDATE, 50, 10, 0);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH13', 'user1', SYSDATE, 0, 0, 0);

-- USER11이 CH14, CH15, CH16 수강 (L2 관련 챕터들)
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH14', 'user1', SYSDATE, 100, 20, 1);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH15', 'user1', SYSDATE, 100, 25, 1);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH16', 'user1', SYSDATE, 30, 9, 0);

-- USER12이 CH17, CH18, CH19 수강 (L3 관련 챕터들)
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH17', 'user1', SYSDATE, 100, 15, 1);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH18', 'user1', SYSDATE, 80, 20, 0);
INSERT INTO MY_CHAPTER VALUES ('MC' || SEQ_MY_CHAPTER_ID.NEXTVAL, 'CH19', 'user1', SYSDATE, 10, 3, 0);
